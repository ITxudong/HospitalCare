        ...
        <div class="box">
          <div class="box-header">
            <span class="title">
              ...
              <a href="/insurance/insuranceSet.action"> 医保类型列表</a>  /  修改医保类型
            </span>
          </div>
          <div class="box-body form">
            <form action="/insurance/updateInsurance.action" method="post">
              <input type="hidden" name="insurance.id" value="${insurance.id }">
              <label>医保类型名称</label>
              <input type="text" name="insurance.name" value=${insurance.name }>
